...
| 3-2 | 常見費用報帳與抵稅速查工具 | `v1.5.41` | `/3-2/` | [開啟工具](https://sytax-academy.github.io/shengyan-tools/3-2/) | `https://tools.sytaxes.com/3-2/`（待切換） | `2026-09-13` | DEPLOYED / PUBLIC SMOKE PENDING |
